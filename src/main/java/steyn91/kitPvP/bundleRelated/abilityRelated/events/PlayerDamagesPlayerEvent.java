...
public class PlayerDamagesPlayerEvent extends Event {
    ...
    public PlayerDamagesPlayerEvent(PlayerModel source, PlayerModel target, double damageAmount, DamageType type){
        this.source = source;
        this.target = target;
