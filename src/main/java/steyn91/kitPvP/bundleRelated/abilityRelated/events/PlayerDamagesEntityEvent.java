...
public class PlayerDamagesEntityEvent extends Event {

    @Getter private final PlayerModel source;
    ...
    public PlayerDamagesEntityEvent(PlayerModel source, LivingEntityModel target, double damageAmount, DamageType type){
        this.source = source;
        this.target = target;
